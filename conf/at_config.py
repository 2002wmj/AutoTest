...
#AutoTest database info
MySQL_Name = 'autotest'   # Don't change this database name
MySQL_Host = '192.168.2.151'  # Your Mysql hostname
MySQL_Port = '3306'       # Your Mysql port
MySQL_User = 'root'       # Your Mysql username
MySQL_Pass = 'root'           # Your Mysql password, '' means no password.